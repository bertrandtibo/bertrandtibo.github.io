...
<div class="clearfix">
<img style="padding: 0 15px 10px 10px; float: left" width="320" src="{{ page.profile.img_TB | prepend: '/assets/img/' | prepend: site.baseurl | prepend: site.url }}">
...
<!-------------------------------------------->
<div class="clearfix">
<img style="padding: 0 15px 10px 10px; float: left" width="600" src="{{ page.profile.img_GM_2022 | prepend: '/assets/img/' | prepend: site.baseurl | prepend: site.url }}">


<p align="justify">Group photo following a joint group meeting with the <a href="https://www.imperial.ac.uk/non-equilibrium-systems/">nonequilibrium systems group</a> of <a href="https://www.ma.imperial.ac.uk/~pruess/">Gunnar Pruessner</a>, November 4th 2022. 
</p>
...
* __Bilal Botté__ (MSc in Applied Mathematics, Imperial College London, 2022)

* __Filip Weidler__ (MSci in Mathematics, Imperial College London, 2022)

* __Eleanor Hall__ (MSci in Mathematics, Imperial College London, 2022)
